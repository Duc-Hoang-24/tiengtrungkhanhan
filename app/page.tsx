      ...
      <div className='grid lg:grid-cols-2 sm:grid-cols-1 w-full mx-auto gap-1 px-4 sm:px-4 md:px-6 lg:px-8 xl:px-12'>
        ...
        >
          ...
          >
            ...
            className='w-full md:w-auto bg-yellow-200 text-amber-950 text-lg rounded-lg px-6 py-3 mt-4 hover:bg-amber-400 font-semibold hover:shadow-[5px_5px_10px_rgba(200,200,200)] hover:scale-105 transition-all duration-300 ease-in-out'
            >
              Xem chi tiết
            </button>
          </div>
          ...
          >
            ...
            className='w-full md:w-auto bg-yellow-200 text-amber-950 text-lg rounded-lg px-6 py-3 mt-10 hover:bg-amber-400 font-semibold hover:shadow-[5px_5px_10px_rgba(200,200,200)] hover:scale-105 transition-all duration-300 ease-in-out'
            >
              Xem chi tiết
            </button>
          </div>
